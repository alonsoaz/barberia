...
public class BuscarReservaPorCliente {
	...
	public BuscarReservaPorCliente(int aidReserva, String bCod, String cCLient, String dServicio, String eBarbero,
			String fInicio, String gFin, String eEstado) {
		super();
