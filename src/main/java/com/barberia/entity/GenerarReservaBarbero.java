...
public class GenerarReservaBarbero {
	...
	public GenerarReservaBarbero(int aidBarbero, int bidCliente, int cYear, int dMonth, int eDay, int fHour, int gMinut,
			int hSeconds, int iidServicio) {
		super();
