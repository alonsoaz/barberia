...
public class ListarReservasPorCliente {
	...
	public ListarReservasPorCliente(int aidReserva, String bCLiente, String cServicio, String dcodBarbero,
			String fBarbero, String gInicio, String hFin, String iEstado) {
		super();
	...
	public String getDcodBarbero() {
		return dcodBarbero;
	}
	public void setDcodBarbero(String dcodBarbero) {
		this.dcodBarbero = dcodBarbero;
	}
	public String getfBarbero() {
		return fBarbero;
	}
