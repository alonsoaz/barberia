...
public class ListarReservasPorClienteInterno {
	...
	public ListarReservasPorClienteInterno(String aCod, String bCliente, String cServicio, String dBarbero,
			String eInicio, String fFin, String gEstado) {
		super();
		this.aCod = aCod;
	...
	public void setdBarbero(String dBarbero) {
		this.dBarbero = dBarbero;
	}
