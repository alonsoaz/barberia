...
public class ListarClienteInterno {
	...
	public ListarClienteInterno(String aidCliente, String bCodigo, String completo, String dni, String estado,
			String gCelular, String hEmail, String jDireccion, String kModifiedBy, String ldate) {
		super();
		this.aidCliente = aidCliente;
		this.bCodigo = bCodigo;
		this.completo = completo;
