...
public class BuscarUsuario {
	...
	private int IdUnico;
	public BuscarUsuario(String aidUsuario, String bCod, String cnombre, String dargo, String eaka, String fmail,
			String gcelular, String hDescripcion, int idUnico) {
		super();
