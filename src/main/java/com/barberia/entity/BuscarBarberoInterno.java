...
public class BuscarBarberoInterno {
	...
	public BuscarBarberoInterno(String aidBarbero, String bcod, String eCompleto, String fEstado, String hcelular,
			String iDni, String jEmail, String kDireccion, String lModifiedBy, String mdate, int lIdUnico) {
		super();
