...
public class ListarServicioInterno {
	...
	public ListarServicioInterno(int aidServicio, String bCod, String cNombre, String eEstado, int fDuracion,
			double gPrecio, String hDescripcion, String jUser, String kDate) {
		super();
