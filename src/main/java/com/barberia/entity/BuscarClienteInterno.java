...
public class BuscarClienteInterno {
	...
	public BuscarClienteInterno(String aiDCliente, String bCod, String cCompleto, String dni, String fEsatado,
			String gCelular, String hEmail, String jDireccion, String kModifiedBy, String ldate, int mIdUnico) {
		super();
