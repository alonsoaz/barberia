...
public class MostrarDetalleVentaInterno {
	...
	public MostrarDetalleVentaInterno(int aidDEtVenta, int bidVenta, String cCodVenta, String dCodCliente,
			String eCodCDetalle, String fecha, String gEstado, String hCliente, String iTipo, String jProducto,
			String kMarca, double lPrecio, int mCantidad, double nDescuento, double oSubtotal) {
		super();
