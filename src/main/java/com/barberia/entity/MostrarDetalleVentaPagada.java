...
public class MostrarDetalleVentaPagada {
	...
	public MostrarDetalleVentaPagada(String cCodVenta, String dCodCliente, String dCodDet, String eFecha,
			String fEstado, String gCliente, String hTipo, String iProducto, String jMarca, double kPrecio,
			int lCantidad, double mDescuento, double nSubtotal) {
		super();
