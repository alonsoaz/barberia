...
public class BuscarServicioInterno {
	...
	public BuscarServicioInterno(int aidServicio, String bCod, String cNombre, String eEstado, int fDuracion,
			double gPrecio, String hDescripcion, String jUser, String kDate, int lidUnico) {
		super();
