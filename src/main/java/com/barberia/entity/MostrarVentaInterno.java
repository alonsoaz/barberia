...
public class MostrarVentaInterno {
	...
	public MostrarVentaInterno(int aidVenta, String bcodVenta, String codCliente, String dEstado, String fCliente,
			double gTotal, String hFecha) {
		super();
