...
public class MostrarDetalleVenta {
	...
	public MostrarDetalleVenta(int aidDetalleventa, int bidVenta, String cCodVenta, String dCodClient, String eCodDet,
			String fecha, String gEstado, String hCLiente, String iTipo, String jProducto, String kMarca,
			double lPrecio, int mCantidad, double nDescuento, double oSubtotal) {
		super();
