...
public class ListarProductoInterno {
	...
	public ListarProductoInterno(int aidProducto, String bcodigo, String dTipo, String eProd, String gMarca,
			String iEstado, int jCantidad, double kPrecio, String lDescripcion, String nUser, String odate) {
		super();
