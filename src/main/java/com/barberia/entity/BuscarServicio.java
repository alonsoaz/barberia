...
public class BuscarServicio {
	...
	public BuscarServicio(int aidServicio, String bcodServicio, String cServicio, String destado, int eDuracion,
			double fPrecio, String gdescripcion, int hIdunico) {
		super();
